    ...
    */
    ...
    componentDidMount: function() {
        ...
        pagingbar.on('pagingbar-button-click', function(event) {
            ...
            console.log('pagingbar event:', buttonType);
        }.bind(this));
    },
    ...
    render: function() {
        ...
        var tableObject = 
            <div className={ this.state.containerClassNames.join(' ') } >
                ...
                <PagingBar data={ this.state.paging } ref="pagingbar" />
            </div>
        return tableObject;
    }
});
...
var PagingBar = React.createClass({
    ...
    onPagingButtonClick: function(event) {
        ...
        if (target.hasClass('btn-paging-back')) {
            buttonType = 'back';
        }
        if (target.hasClass('btn-paging-next')) {
            buttonType = 'next';
        }
        if (target.hasClass('btn-paging-end')) {
            buttonType = 'end';
        }
        console.log('>>> button click:', buttonType);
        if (buttonType) {
            this.fire('pagingbar-button-click', [{ target:target, type:buttonType }]);
        }
    },
