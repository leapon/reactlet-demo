...
var Table = React.createClass({
    ...
    */
    ...
    getDisplayRows: function() {
        ...
        if (this.state.paging) {
            ...
            for (var i = start; i < stop; i++) {
                rows.push(this.state.dataItems[i]);
            }
        } else {
    ...
    render: function() {
        ...
        // add pagingbar if available
        var pagingBar = null;
        if (this.state.paging) {
            var pagingBarData = this.state.paging;
            pagingBar = <PagingBar data={ pagingBarData } />;
        }
        return (
...
var PagingBar = React.createClass({
    ...
    getAttributes: function() {
        var attributes = [
            ...
            { name:'total', type:'number', required:true, defaultValue:1, note:'total count' },
    ...
    render: function() {
        // set content display
        var pages = Math.ceil(this.state.total/this.state.size);
        var pagingStatus = this.state.page + '/' + pages;
        var content =
            <div className="pagingbar-content-container" >
                <span className="table-body-cell-text-container">{ pagingStatus }</span>
            </div>;
        return (
            <div className={ this.state.containerClassNames.join(' ') }>
                { content }
